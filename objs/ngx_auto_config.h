#define NGX_CONFIGURE " --with-cc=/home/jara/Desktop/RISC-V/toolchains/bin/riscv64-unknown-linux-gnu-gcc --with-cpp=/home/jara/Desktop/RISC-V/toolchains/bin/riscv64-unknown-linux-gnu-gcc --without-http_auth_basic_module --without-http_rewrite_module --without-http_gzip_module --with-cc-opt='-DAO_USE_PTHREAD_DEFS=1 -DNGX_HAVE_MAP_ANON=1 -DNGX_HAVE_LIBATOMIC=1 -DNGX_SYS_NERR=150 -DNGX_CRYPT=0 -DNGX_HAVE_GNU_CRYPT_R=1 -Isrc/libatomic_ops -Wno-deprecated-declarations' --with-libatomic --with-ld-opt=-lpthread --with-http_ssl_module --with-openssl=/home/jara/Desktop/riscv-mini/openssl --with-openssl-opt='linux64-riscv64 --cross-compile-prefix=riscv64-unknown-linux-gnu- CPPFLAGS=-I/home/jara/Desktop/riscv-mini/domvlib LDFLAGS=-L/home/jara/Desktop/riscv-mini/domvlib LDLIBS=-ldomv'"
